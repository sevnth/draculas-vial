# Precision Theme Generator for Dracula's Vial
...
foreach ($t in $themes) {
    ...
    # Preserve colors block
    $colors = $json.colors

    # 1. Complete semanticTokenColors
    ...
    # 2. Precision TextMate tokenColors matching HTML preview spans
    $tokenColors = @(
        # Comments (syn-slate / syn-comment)
        @{
            name = "Comments"
            scope = @(
                "comment",
        ...
        # Storage & Type Declarations (syn-pink)
        @{
        ...
        # Variable Declarations (var, let, const, def, fn)
        @{
            name = "Variable & Function Declaration Keywords"
            scope = @(
        ...
        # Primitive Types (string, int, bool, uint64, float64, error) -> syn-green
        @{
        ...
        # Custom Types, Structs, Interfaces, Classes (syn-green & italic)
        @{
        ...
        # Package & Namespace Names (syn-cyan)
        @{
        ...
        # Go Struct Field Declarations & Composite Literal Keys (syn-pink)
        @{
        ...
        # Function Parameters & Receivers (syn-tangerine & italic)
        @{
        ...
        # Struct Tags & Raw Strings & Attributes (syn-tangerine)
        @{
        ...
        # Strings & Text Literals (syn-orange)
        @{
            name = "Strings & Quotes"
            scope = @(
                "string",
        ...
        # Booleans, Nil, Null, None (syn-yellow & bold)
        @{
        ...
        # User Constants & Enum Members (syn-yellow)
        @{
        ...
        # Tags & JSX / HTML Elements (syn-cyan)
        @{
        ...
        # Operators & Punctuation (syn-purple)
        @{
        ...
        # Brackets & Delimiters (syn-purple / syn-fg)
        @{
    ...
    Write-Host "Generated precision theme: $($t.file)"
}

Write-Host "All 7 precision themes generated successfully!"
